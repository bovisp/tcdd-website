<template>
    ...
    >
        {{ showing ? trans('js_pages_assessments_assessments_components_results_assessmentresultsshowall.recall') : trans('js_pages_assessments_assessments_components_results_assessmentresultsshowall.publish') }} all results
    </button>
</template>
