<template>
    <div class="w-full">
        <h1 class="text-3xl font-bold mb-4">
            {{ trans('js_pages_admin_tags_tagscreate.newtag') }}
        </h1>
        ...
        >
            ...
            >
                ...
                >
                    {{ trans('js_pages_admin_tags_tagscreate.addtag') }}
                </button>
...
export default {
    ...
    methods: {
        cancel () {
            window.events.$emit('tags:create-cancel')
        ...
        async store () {
            let { data } = await axios.post(`${this.urlBase}/api/admin/tags`, this.form)
